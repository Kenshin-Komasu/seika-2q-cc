...
(0,animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
  ...
  var colorPicker = (function() {
    var colors = ["#FF6138", "#7FFFD4", "#2980B9", "#282741"];
    var index = 0;
    function next() {
  ...
  function handleEvent(e) {
      ...
      var fillAnimation = (0,animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        targets: pageFill,
        r: targetR,
      ...
      var rippleAnimation = (0,animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        targets: ripple,
        r: rippleSize,
        opacity: 0,
        easing: "easeOutExpo",
      ...
      for (var i=0; i<32; i++) {
        var particle = new Circle({
          ...
          y: e.pageY,
          fill: currentColor,
          r: animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(24, 48)
        })
        particles.push(particle);
      }
      var particlesAnimation = (0,animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
        targets: particles,
        x: function(particle){
          return particle.x + animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(rippleSize, -rippleSize);
        },
        y: function(particle){
          return particle.y + animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(rippleSize * 1.15, -rippleSize * 1.15);
        },
        r: 0,
        easing: "easeOutExpo",
        duration: animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(1000,1300),
        complete: removeAnimation
      });
  ...
  var animate = (0,animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"])({
    duration: Infinity,
    update: function() {
  ...
  function startFauxClicking() {
    setTimeout(function(){
      fauxClick(animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random( cW * .2, cW * .8), animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(cH * .2, cH * .8));
      startFauxClicking();
    }, animejs_lib_anime_es_js__WEBPACK_IMPORTED_MODULE_0__["default"].random(200, 900));
  }
